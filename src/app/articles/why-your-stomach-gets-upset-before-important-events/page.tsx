            ...
            <main className="pt-32 pb-24 text-slate-900 dark:text-slate-100">
                <article className="max-w-4xl mx-auto px-6 font-sans">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed max-w-none">
                        ...
                        <p>Mason Natural Peppermint Oil capsules are enteric-coated, which means they don&#39;t dissolve in your stomach - they dissolve in your intestines, where they&#39;re most effective. Take one capsule 30-60 minutes before the event. If capsules feel like too much when you&#39;re already nauseous, brew a cup of peppermint or <a href="https://amzn.to/4suWJdf" target="_blank" rel="noopener noreferrer" className="text-primary font-medium hover:underline">chamomile tea</a> instead. Chamomile has a similar calming effect on the gut and also helps reduce overall anxiety. Sip it slowly while you&#39;re getting ready. You may also find relief with <a href="https://amzn.to/4bKBPiU" target="_blank" rel="noopener noreferrer" className="text-primary font-medium hover:underline">digestive enzymes</a>.</p>
