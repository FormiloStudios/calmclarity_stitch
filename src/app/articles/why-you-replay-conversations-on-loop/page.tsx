            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <ul>
                            <li><strong>Give your hands something to do.</strong> A <a href="/articles/best-fidget-rings-for-anxiety-tested-and-compared" className="text-primary hover:underline font-bold">fidget ring</a> or <a href="https://amzn.to/4chc7Ey" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">therapy putty</a> gives your restless energy somewhere to go. When your hands are occupied, it&#39;s harder for your brain to stay fully locked into the rumination spiral.</li>
                            <li><strong>Use physical grounding.</strong> If you&#39;re lying in bed ruminating, get under a <a href="/articles/best-weighted-blankets-for-anxiety-tested-and-compared" className="text-primary hover:underline font-bold">weighted blanket</a>. The deep pressure helps signal to your nervous system that you&#39;re safe.</li>
