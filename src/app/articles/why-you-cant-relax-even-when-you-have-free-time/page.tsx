            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <p>The Yoga Nidra: Deep Rest and Renewal course from Mindful teaches you how to access deep relaxation even when your nervous system is stuck in overdrive. <a href="https://shop.mindful.org/products/yoga-nidra-deep-rest-and-renewal?sca_ref=10870558.SjISUzYe2p" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">Try the Yoga Nidra Course →</a></p>
                        ...
                        <p>A weighted blanket provides deep pressure that activates your parasympathetic nervous system. <Link href="/articles/best-weighted-blankets-for-anxiety-tested-and-compared" target="_blank" className="text-primary hover:underline font-bold">Check out Weighted Blankets →</Link></p>
                        <p>An acupressure mat forces your nervous system to focus on intense physical sensation. The spikes are uncomfortable enough that your brain has to pay attention to them. That breaks the mental loop of anxious thoughts and redirects your focus to something physical and immediate. <Link href="/articles/best-acupressure-mats-for-anxiety-and-stress-relief" target="_blank" className="text-primary hover:underline font-bold">Read our guide on the Best Acupressure Mats →</Link></p>
                        ...
                        <p>A 20-minute Epsom salt bath is one of the simplest rituals. The magnesium in the salt absorbs through your skin and supports nervous system regulation. Dr Teal&#39;s Lavender Epsom Salt is inexpensive, easy to find, and the lavender scent adds a calming sensory cue. <a href="https://amzn.to/4sQgVFU" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">Get Dr Teal&#39;s Lavender Epsom Salt →</a></p>
