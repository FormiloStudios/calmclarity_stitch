            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <p>Family gatherings create a lot of restless energy that has nowhere to go. A <a href="/articles/best-fidget-rings-for-anxiety-tested-and-compared" className="text-primary hover:underline font-bold">fidget ring</a> gives your hands something to do without being obvious. You can quietly spin it while you&#39;re listening to someone talk. If you have pockets, <Link className="text-primary hover:underline font-bold" href="#">therapy putty</Link> works too - squeezing it under the table gives your hands an outlet.</p>
                        ...
                        <p><strong>After:</strong> When you get home, get under a <a href="/articles/best-weighted-blankets-for-anxiety-tested-and-compared" className="text-primary hover:underline font-bold">weighted blanket</a>. The deep pressure helps signal to your body that the performance is over and you are safe. If you&#39;re too wound up, use an <Link className="text-primary hover:underline font-bold" href="#">acupressure mat</Link> for 10-15 minutes.</p>
