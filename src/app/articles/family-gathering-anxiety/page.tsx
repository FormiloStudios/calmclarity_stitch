            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <p>Family gatherings create a lot of restless, anxious energy that has nowhere to go. A <a href="/articles/best-fidget-rings-for-anxiety-tested-and-compared" className="text-primary hover:underline font-bold">fidget ring</a> gives your hands something to do without being obvious. You can quietly spin it while you&#39;re listening to someone talk. If you have pockets, <a href="https://amzn.to/465CSIr" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">therapy putty</a> works too - squeezing it under the table gives your hands an outlet.</p>
