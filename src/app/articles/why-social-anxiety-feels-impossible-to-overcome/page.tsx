            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <p>The Complete Social Confidence System is designed specifically for people with social anxiety. It&#39;s not generic self-help. It&#39;s a step-by-step program that addresses the root cause: your nervous system&#39;s overreaction to social situations. <a href="http://www.betterdailyguide.site/ds24/the-10-minute-social-confidence-trick#aff=Select_partner" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">Try the Complete Social Confidence System →</a></p>
                        <p>If you&#39;re looking for something more affordable, the Udemy course &quot;How I Overcame Social Anxiety, Grew Confidence &amp; Self-Esteem&quot; is an excellent starting point. It&#39;s taught by someone who&#39;s actually been through severe social anxiety (not just someone who read about it in a textbook). <a href="https://www.udemy.com/course/build-rock-solid-confidence-self-esteem-become-your-best/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">Try the Udemy Course →</a></p>
                        ...
                        <p>Social anxiety is a nervous system issue, which means supporting your nervous system biochemically can help. L-Theanine is an amino acid found in tea that promotes calm focus without making you drowsy. It increases GABA, serotonin, and dopamine. <a href="https://amzn.to/4sjGeQQ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">Get Nutricost L-Theanine →</a></p>
