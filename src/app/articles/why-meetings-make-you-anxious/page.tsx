            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed">
                        ...
                        <p>If you need help with focus and mental clarity during meetings — like your brain goes blank when you&#39;re anxious - something like <a href="https://yu.com/products/focus" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">BrainAMP</a> can help. It supports cognitive function and mental energy without the jittery feeling that comes from just drinking more coffee.</p>
