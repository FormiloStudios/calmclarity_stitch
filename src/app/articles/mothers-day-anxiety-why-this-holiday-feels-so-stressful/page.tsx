            ...
            <main className="pt-32 pb-24 text-slate-900 dark:text-slate-100">
                <article className="max-w-4xl mx-auto px-6 font-sans">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate mx-auto font-light leading-relaxed max-w-none">
                        ...
                        <div className="my-10">
                            <a href="https://amzn.to/4bKBPiU" target="_blank" rel="noopener noreferrer" className="inline-block w-full text-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] shadow-2xl hover:bg-primary hover:text-white transition-all">View Healthy Boundaries Toolkit</a>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 my-10">
                            <a href="https://mindful.shorthandstories.com/befriend-difficult-emotions/" target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] shadow-2xl hover:bg-primary hover:text-white transition-all">Befriend Difficult Emotions</a>
                            <a href="https://mindful.shorthandstories.com/radical-self-care/" target="_blank" rel="noopener noreferrer" className="flex-1 text-center border-2 border-slate-900 dark:border-white text-slate-900 dark:text-white py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all">Radical Self-Care Course</a>
                        </div>
                        ...
                        <p>A spa gift basket isn&#39;t just bath products. It&#39;s permission to rest - something a lot of mothers won&#39;t give themselves. It signals that self-care is allowed, even necessary. If your mother is the type who journals or processes emotions through writing, a guided journal designed specifically for mothers can be meaningful. Mom&#39;s Life Story Journal includes over 250 prompts that help her reflect on her own life, not just her role as a mother. It&#39;s a way to acknowledge her as a whole person. The goal isn&#39;t to find the gift that fixes everything. It&#39;s to find something thoughtful that doesn&#39;t drain you to give.</p>
                        <div className="flex flex-col sm:flex-row gap-4 my-10">
                            <a href="https://amzn.to/4c1xoSd" target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] shadow-2xl hover:bg-primary hover:text-white transition-all">View Spa Basket</a>
                            <a href="https://amzn.to/4rRlQFO" target="_blank" rel="noopener noreferrer" className="flex-1 text-center border-2 border-slate-900 dark:border-white text-slate-900 dark:text-white py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all">View Life Story Journal</a>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-4 mb-16">
                            <a href="https://amzn.to/4sy1dj2" target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] hover:bg-slate-200 transition-all">aromatherapy diffuser</a>
                            <a href="https://amzn.to/4svLeCf" target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white py-6 rounded-full font-bold uppercase text-[0.85rem] tracking-[0.4em] hover:bg-slate-200 transition-all">Anxiety Relief Bracelet</a>
                        </div>
