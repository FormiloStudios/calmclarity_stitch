                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-2 gap-6 text-sm mb-8">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="https://amzn.to/4szpq87" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">View on Amazon</a>
                                                </div>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                                        <div className="space-y-6 md:order-1 order-2">
                                            <div className="grid grid-cols-2 gap-6 text-sm mb-8">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-900 dark:text-white mb-1 uppercase tracking-widest text-[0.7rem]">Link</p>
                                                    <a href="https://amzn.to/4tLiFAZ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">View on Amazon</a>
                                                </div>
                                            </div>
                                            ...
                                            <a href="https://amzn.to/4tLiFAZ" target="_blank" rel="noopener noreferrer" className="block text-center py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold uppercase tracking-widest text-xs rounded-full hover:bg-primary dark:hover:bg-primary hover:text-white transition-all duration-300">Check Q2 Mini on Amazon →</a>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-2 gap-6 text-sm mb-8">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-900 dark:text-white mb-1 uppercase tracking-widest text-[0.7rem]">Link</p>
                                                    <a href="https://amzn.to/4230x9L" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">View on Amazon</a>
                                                </div>
                                            </div>
                                            ...
                                            <a href="https://amzn.to/4230x9L" target="_blank" rel="noopener noreferrer" className="block text-center py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold uppercase tracking-widest text-xs rounded-full hover:bg-primary dark:hover:bg-primary hover:text-white transition-all duration-300">Check RENPHO Thermacool 2 on Amazon →</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                                        <div className="space-y-6 md:order-1 order-2">
                                            <div className="grid grid-cols-2 gap-6 text-sm mb-8">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-900 dark:text-white mb-1 uppercase tracking-widest text-[0.7rem]">Link</p>
                                                    <a href="https://amzn.to/4c97X1b" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">View on Amazon</a>
                                                </div>
                                            </div>
                                            ...
                                            <a href="https://amzn.to/4c97X1b" target="_blank" rel="noopener noreferrer" className="block text-center py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold uppercase tracking-widest text-xs rounded-full hover:bg-primary dark:hover:bg-primary hover:text-white transition-all duration-300">Check Theragun Relief on Amazon →</a>
                                        </div>
                                        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl group border border-slate-100 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 min-h-[400px] md:order-2 order-1">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-2 gap-6 text-sm mb-8">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-900 dark:text-white mb-1 uppercase tracking-widest text-[0.7rem]">Link</p>
                                                    <a href="https://amzn.to/48wUXQF" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">View on Amazon</a>
                                                </div>
                                            </div>
